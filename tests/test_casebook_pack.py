"""Regression checks for the radian-dev-test-map casebook."""
...
from casebook.harness import assert_expected, radian_dev_test_map_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_dev_test_map_summary(), assert_expected())
