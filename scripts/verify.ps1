...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-radian-dev-test-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-radian-dev-test-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-radian-dev-test-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-radian_dev_test_map-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
